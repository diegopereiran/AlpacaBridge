---
name: ascom-alpaca-driver
description: Implement, extend, or review ASCOM Alpaca devices and drivers against the official device interfaces and HTTP/JSON protocol. Use for driver architecture, endpoint behavior, asynchronous operations, errors, discovery, management APIs, ImageBytes, conformance, and code review; do not use for application-only code that merely consumes an existing compliant driver.
---

# ASCOM Alpaca Driver Development
