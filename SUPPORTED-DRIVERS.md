...
- **Tested models**: Nikon D5300, Nikon D3200 and Nikon D3300 on Linux arm64 (USB), same rig, same AlpacaBridge device slot -- swapped without reconfiguration. The D3300 primed as 6016x4016, MaxADU 4095, 3.92 micron pixels (libgphoto2 2.5.31, AlpacaBridge 4.0.0).
- **ConformU**: 4.5.1 — 0 errors, 0 issues, 0 timing issues on all three.
